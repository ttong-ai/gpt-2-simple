...
"""from https://github.com/tensorflow/tensor2tensor/blob/master/tensor2tensor/utils/adafactor.py"""
...
"""adafactor_decay_rate_adam(beta2) removed"""
...
"""adafactor_optimizer_from_hparams(hparams, lr) removed"""
